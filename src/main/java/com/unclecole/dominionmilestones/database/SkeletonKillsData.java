...
public class SkeletonKillsData {

    private static final transient SkeletonKillsData instance = new SkeletonKillsData();
    ...
    public static void load() {
        ...
        new Serializer().load(instance, SkeletonKillsData.class, "skeletonkillsdata");
