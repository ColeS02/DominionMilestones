...
public class C {
	...
	public static String getFormattedTime(long timeInS) {
		String result = "";

		long days = timeInS / 86400;
		if(days > 0) {
			result +=(days + "d ");
		}

		long hrs = timeInS % 86400 / 3600;
		if (hrs > 0)
			result += (hrs + "h ");

		long mins = timeInS % 86400 % 3600 / 60;
		if (mins > 0)
			result += (mins + "m ");

		long secs = timeInS % 86400 % 3600 % 60;
